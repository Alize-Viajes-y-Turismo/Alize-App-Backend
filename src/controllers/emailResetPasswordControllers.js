...
const { generateRandomString, generateHash } = require('../utils/credentialsUtil'); // Importamos funciones de utilidad para generar cadenas aleatorias y hashes
const { getEmailTemplate } = require('../template/template'); // Importamos una función para obtener una plantilla de correo electrónico
const { sendEmail } = require('../utils/emailUtil'); // Importamos una función para enviar correos electrónicos
